...
class Top1Net(BasicModule):
    def __init__(self, num_classes=55):
        ...
        self.fc = nn.Linear(256 * len(self.sizes) + 11, num_classes)  #fully connected with age, sex
        self.sigmoid = nn.Sigmoid()  # multi-task

    def forward(self, x0, age, sex):
        x0 = x0.unsqueeze(1)
