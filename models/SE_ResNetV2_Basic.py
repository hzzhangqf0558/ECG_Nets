...
def se_resnetV2_b_18( num_classes=55):
    """Constructs a ResNet-18 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = SENet(BasicBlock, [2, 2, 2, 2], num_classes)
    return model


def se_resnetV2_b_34( num_classes=55):
...
def se_resnetV2_b_50(num_classes=55):
...
def se_resnetV2_b_101( num_classes=55):
...
def se_resnetV2_b_152( num_classes=55):
