...
def se_resnetV2_18( num_classes=55):
...
def se_resnetV2_34( num_classes=55):
...
def se_resnetV2_50(num_classes=55):
...
def se_resnetV2_101( num_classes=55):
...
def se_resnetV2_152( num_classes=55):
