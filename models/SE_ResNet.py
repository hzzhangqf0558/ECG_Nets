...
def se_resnet_18( num_classes=55):
...
def se_resnet_34( num_classes=55):
...
def se_resnet_50(num_classes=55):
...
def se_resnet_101( num_classes=55):
...
def se_resnet_152( num_classes=55):
