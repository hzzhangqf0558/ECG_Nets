...
def get_train_label(label_path, str2ids, train_csv_path, validation_csv_path,
    ...
    df_train = df[:train_len] #split data
    print(df.shape)
    df_val = df[train_len:]
...
if __name__ == '__main__':
    ...
    #label_path = './all_data/hf_round1_label.txt'
    #label_path = './all_data/heifei_round1_ansA_20191008.txt'
    label_path = './all_data/hf_round2_train.txt'
    ...
    trainval_csv_path = './all_data/hf_round2_label_testA.csv'
    ...
    # trainval_csv_path = './all_data/hf_round1_label_testA.csv'
