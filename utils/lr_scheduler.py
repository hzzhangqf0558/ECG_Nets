...
class LRScheduler(object):
    ...
    def __init__(self, optimizer, niters, args):
        ...
        assert(self.mode in ['step', 'poly', 'cosine',' exponent'])
        ...
        self.decay_steps = args.decay_steps if hasattr(args, 'decay_steps') else niters
    ...
    def update(self, i, epoch):
        ...
        if self.warmup_iters > T:
            ...
            if self.mode == 'step':
                ...
                self.learning_rate = self.learning_rate * pow(self.decay_factor, self.max_iter / self.decay_steps)
